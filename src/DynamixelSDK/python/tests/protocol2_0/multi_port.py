...
dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(
    portHandler1, DXL1_ID, ADDR_TORQUE_ENABLE, TORQUE_ENABLE
)
...
dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(
    portHandler2, DXL2_ID, ADDR_TORQUE_ENABLE, TORQUE_ENABLE
)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
...
while 1:
    ...
    if (
        ...
        dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(
            portHandler1, DXL1_ID, ADDR_GOAL_POSITION, dxl_goal_position[index]
        )
    else:
    ...
    if (
        ...
        dxl2_comm_result, dxl_error = packetHandler.write2ByteTxRx(
            portHandler2, DXL2_ID, ADDR_GOAL_POSITION, dxl_goal_position[index]
        )
    else:
        dxl2_comm_result, dxl_error = packetHandler.write4ByteTxRx(
            portHandler2, DXL2_ID, ADDR_GOAL_POSITION, dxl_goal_position[index]
        )
    if dxl_comm_result != COMM_SUCCESS:
        print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
    ...
    while 1:
        ...
        if (
            ...
            (
                ...
                portHandler1, DXL1_ID, ADDR_PRESENT_POSITION
            )
        else:
            (
                dxl1_present_position,
        ...
        if (
            ...
            (
                ...
                portHandler2, DXL2_ID, ADDR_PRESENT_POSITION
            )
        else:
            (
                dxl2_present_position,
        ...
        if not (
            ...
            and (
                abs(dxl_goal_position[index] - dxl2_present_position)
                > DXL_MOVING_STATUS_THRESHOLD
            )
        ):
            break
...
dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(
    portHandler1, DXL1_ID, ADDR_TORQUE_ENABLE, TORQUE_DISABLE
)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
...
dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(
    portHandler2, DXL2_ID, ADDR_TORQUE_ENABLE, TORQUE_DISABLE
)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
